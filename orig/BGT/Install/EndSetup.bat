...
_weidu --game "%BG1PATH%" --out BG1MISC --biff-get-rest MBASG.*
_weidu --game "%BG1PATH%" --out BG1MISC --biff-get-rest MTASG.*
::Extracts item graphics
_weidu --game "%BG1PATH%" --out BG1MISC --biff-get-rest CMISC1B.BAM CMISC1G.BAM CMISC1H.BAM CMISC1I.BAM
_weidu --game "%BG1PATH%" --out BG1MISC --biff-get-rest CMISC2A.BAM CMISC2B.BAM CMISC2C.BAM CMISC2F.BAM CMISC2G.BAM CMISC2H.BAM CMISC2I.BAM CMISC2K.BAM CMISC2L.BAM CMISC2M.BAM CMISC2N.BAM CMISC2P.BAM
_weidu --game "%BG1PATH%" --out BG1MISC --biff-get-rest CMISC91.BAM CMISC92.BAM CMISC94.BAM CMISC95.BAM CMISC98.BAM
_weidu --game "%BG1PATH%" --out BG1MISC --biff-get-rest CPLAT08.BAM ISW1H06.BAM ISW1H18.BAM ISW2H07.BAM
...
move override\BGTCRED.BMP BG1MISC > NUL
